...
$classes = ($active ?? false)
            ? 'block w-full ps-3 pe-4 py-2 border-l-4 border-[#232f3e] text-start text-base font-medium text-[#232f3e] bg-slate-50 focus:outline-none focus:text-[#232f3e] focus:bg-slate-100 focus:border-[#232f3e] transition duration-150 ease-in-out'
