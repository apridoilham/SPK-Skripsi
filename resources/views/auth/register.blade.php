        ...
        <div class="relative w-full max-w-5xl bg-white shadow-lg rounded-lg overflow-hidden flex flex-col md:flex-row m-4 z-10 border border-gray-200">
            ...
            <div class="w-full md:w-5/12 p-10 flex flex-col justify-between bg-[#232f3e] text-white relative overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <h1 class="text-3xl font-bold leading-tight mb-4">{{ __('Join Us') }}</h1>
                    <p class="text-gray-300 leading-relaxed font-light">
                        {{ __('A brilliant career awaits you at PT. Bhandawa Metafora Warsoyo. Register now and achieve your dreams.') }}
                    </p>
                </div>
            ...
            <div class="w-full md:w-7/12 p-10 bg-white relative">
                <div class="mb-8">
                    <h2 class="text-2xl font-bold text-[#232f3e]">{{ __('Create New Account 🚀') }}</h2>
                    <p class="text-gray-500 mt-2 text-sm">{{ __('Complete your personal data to create an applicant account.') }}</p>
                </div>
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-5">
                    ...
                    <div class="space-y-2">
                        <label for="name" class="text-sm font-bold text-gray-700">{{ __('Full Name') }}</label>
                        <div class="relative">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="space-y-2">
                            <label for="password_confirmation" class="text-sm font-bold text-gray-700">{{ __('Confirm Password') }}</label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                    <svg class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <button type="submit" class="w-full py-3 px-4 bg-[#232f3e] hover:bg-[#1a232e] text-white font-bold rounded shadow-sm transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#232f3e] mt-4">
                        {{ __('Register Now') }}
                    </button>
                </form>
                ...
                <div class="mt-8 pt-6 border-t border-gray-100 text-center">
                    <p class="text-gray-500 text-sm">
                        ...
                        <a href="{{ route('login') }}" class="font-bold text-[#232f3e] hover:text-blue-600 hover:underline transition-colors">
                            {{ __('Login here') }}
                        </a>
                    </p>
                </div>
